...
{
    private readonly ILogger<ResilientErrorHandler> _logger;
    
    // .NET 9: Use FrozenSet for O(1) lookups with zero allocations
    private static readonly FrozenSet<Type> RetryableExceptionTypes = new HashSet<Type>
    {
    ...
    private static readonly FrozenDictionary<HttpStatusCode, ErrorCategory> HttpStatusErrorMap = 
    ...
    private static Exception CreateEnhancedException(
    ...
    private static readonly ActivitySource ActivitySource = new("AzureDevOps.MCP.ErrorHandling");
}
