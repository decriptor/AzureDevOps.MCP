...
public interface IAzureDevOpsService
{
	...
	Task<Comment> AddPullRequestCommentAsync(string projectName, string repositoryId, int pullRequestId, string content, int? parentCommentId = null);
	...
	Task<IEnumerable<Microsoft.TeamFoundation.Build.WebApi.Build>> GetBuildsAsync(string projectName, int? definitionId = null, int limit = 20);
	Task<IEnumerable<Microsoft.TeamFoundation.TestManagement.WebApi.TestRun>> GetTestRunsAsync(string projectName, int limit = 20);
	Task<IEnumerable<Microsoft.TeamFoundation.TestManagement.WebApi.TestCaseResult>> GetTestResultsAsync(string projectName, int runId);
