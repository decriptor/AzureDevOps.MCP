...
public class PerformanceService : IPerformanceService
{
    ...
    private readonly ConcurrentDictionary<string, List<long>> _operationDurations = new();
    private readonly ConcurrentDictionary<string, (long success, long failure, long totalDuration)> _apiCallStats = new();
