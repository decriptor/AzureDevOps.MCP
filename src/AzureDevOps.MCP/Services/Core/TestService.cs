...
public class TestService : ITestService
{
	...
	static IEnumerable<TestPlan> GenerateSimulatedTestPlans (string projectName, int limit)
	{
	...
	static TestPlan? GenerateSimulatedTestPlan (string projectName, int planId)
	{
		if (planId > 20) {
	...
	static IEnumerable<TestSuite> GenerateSimulatedTestSuites (string projectName, int planId)
	{
	...
	static IEnumerable<TestRun> GenerateSimulatedTestRuns (string projectName, int? planId, int limit)
	{
		var random = new Random ();
	...
	static TestRun? GenerateSimulatedTestRun (string projectName, int runId)
	{
		if (runId > 100) {
			return null; // Simulate not found
		}
	...
	static IEnumerable<TestResult> GenerateSimulatedTestResults (string projectName, int runId)
	{
