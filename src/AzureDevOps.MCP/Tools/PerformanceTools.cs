...
public class PerformanceTools
{
	...
	[McpServerTool (Name = "get_cache_statistics", ReadOnly = true, OpenWorld = false)]
	[Description ("Gets detailed cache performance and hit rate statistics")]
	public Task<object> GetCacheStatisticsAsync ()
	{
		try {
			...
			throw new InvalidOperationException ($"Failed to get cache statistics: {ex.Message}", ex);
		}
	}
