...
public class AzureDevOpsTools
{
    ...
    private readonly ILogger<AzureDevOpsTools> _logger;
        ...
        [Description("Maximum number of work items to return (default: 100)")] int limit = 100)
    {
        try
        {
            ...
            {
                id = wi.Id,
                title = wi.Fields.ContainsKey("System.Title") ? wi.Fields["System.Title"]?.ToString() : "No title",
                state = wi.Fields.ContainsKey("System.State") ? wi.Fields["System.State"]?.ToString() : "Unknown",
                type = wi.Fields.ContainsKey("System.WorkItemType") ? wi.Fields["System.WorkItemType"]?.ToString() : "Unknown",
                assignedTo = wi.Fields.ContainsKey("System.AssignedTo") ? wi.Fields["System.AssignedTo"]?.ToString() : "Unassigned",
                createdDate = wi.Fields.ContainsKey("System.CreatedDate") ? wi.Fields["System.CreatedDate"] : null,
                changedDate = wi.Fields.ContainsKey("System.ChangedDate") ? wi.Fields["System.ChangedDate"] : null,
                url = wi.Url
            }).ToList();
        }
        catch (Exception ex)
