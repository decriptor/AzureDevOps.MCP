...
public class ModernRateLimitingMiddlewareTests
{
    ...
    private Mock<ILogger<ModernRateLimitingMiddleware>> _mockLogger = null!;
    private Mock<IRateLimitStore> _mockStore = null!;
    private Mock<IOptions<RateLimitingConfiguration>> _mockOptions = null!;
    private RateLimitingConfiguration _config = null!;
    private ModernRateLimitingMiddleware _middleware = null!;
...
{
    private Mock<ILogger<InMemoryRateLimitStore>> _mockLogger = null!;
    private InMemoryRateLimitStore _store = null!;
...
public class RateLimitingDataStructuresTests
{
    ...
    public void RateLimitResult_WithFrozenDictionary_IsImmutable()
    {
        ...
        Assert.IsInstanceOfType(result.Rules, typeof(FrozenDictionary<string, RateLimitCheckResult>));
    }
}
...
public class RateLimitingServiceExtensionsTests
{
    ...
    public void AddModernRateLimiting_RegistersRequiredServices()
    {
        ...
        var middleware = serviceProvider.GetService<ModernRateLimitingMiddleware>();
        
        Assert.IsNotNull(rateLimitStore);
        Assert.IsInstanceOfType(rateLimitStore, typeof(InMemoryRateLimitStore));
