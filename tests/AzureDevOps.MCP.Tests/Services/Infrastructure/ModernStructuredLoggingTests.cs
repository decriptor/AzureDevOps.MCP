...
{
    private Mock<ILogger> _mockInnerLogger = null!;
    private Mock<ISensitiveDataFilter> _mockSensitiveDataFilter = null!;
    private Mock<IOptions<LoggingConfiguration>> _mockOptions = null!;
    private LoggingConfiguration _config = null!;
    private ModernStructuredLogger _logger = null!;
...
public class ModernSensitiveDataFilterTests
{
    private Mock<IOptions<LoggingConfiguration>> _mockOptions = null!;
    private LoggingConfiguration _config = null!;
    private ModernSensitiveDataFilter _filter = null!;
...
public class PerformanceLoggerTests
{
    ...
    private PerformanceLogger _performanceLogger = null!;
...
public class StructuredLoggingExtensionsTests
{
    ...
    public void AddModernStructuredLogging_RegistersRequiredServices()
    {
        ...
        Assert.IsInstanceOfType(filter, typeof(ModernSensitiveDataFilter));
    }
    ...
    public void LogPerformance_ReturnsPerformanceLogger()
    {
        ...
        Assert.IsInstanceOfType(performanceLogger, typeof(PerformanceLogger));
    }
...
public class StructuredDataRecordsTests
{
    ...
    public void ExceptionInfo_SupportsNestedInnerExceptions()
    {
        ...
        var exception = new ExceptionInfo
        {
            ...
            InnerExceptions = new List<ExceptionInfo> { innerException }
        };
