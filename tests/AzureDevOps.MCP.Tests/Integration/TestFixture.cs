...
public class TestDataProvider
{
	...
	private static string GetTestRepositoryName()
	{
		return Environment.GetEnvironmentVariable("TEST_REPOSITORY_NAME") ?? "TestRepo";
	}

	private static int GetTestWorkItemId()
	{
