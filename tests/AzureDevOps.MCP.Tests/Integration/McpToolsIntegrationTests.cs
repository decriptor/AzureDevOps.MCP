...
public class McpToolsIntegrationTests
{
    ...
    private Mock<IAzureDevOpsService> _mockAzureDevOpsService = null!;
    ...
    [TestMethod]
    public async Task AzureDevOpsTools_DependencyInjection_ResolvesCorrectly()
    {
        // Act
    ...
    [TestMethod]
    public async Task SafeWriteTools_DependencyInjection_ResolvesCorrectly()
    {
        // Act
    ...
    [TestMethod]
    public async Task BatchTools_DependencyInjection_ResolvesCorrectly()
    {
        // Act
    ...
    [TestMethod]
    public async Task PerformanceTools_DependencyInjection_ResolvesCorrectly()
    {
        // Act
    ...
    [TestMethod]
    public async Task AllServices_DependencyInjection_ResolvesCorrectly()
    {
        // Act & Assert
    ...
    [TestMethod]
    public async Task Configuration_BindsCorrectly()
    {
        // Act
    ...
    public async Task MultipleTools_ConcurrentExecution_HandledCorrectly()
    {
        ...
        var tasks = new[]
        {
            ...
            Task.Run(() => batchTools.BatchGetWorkItemsAsync(new[] { 1, 2, 3 })),
            Task.Run(() => performanceTools.GetPerformanceMetricsAsync())
        };
